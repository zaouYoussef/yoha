...
export default function PrivacyPage() {
  return (
    <div className="page-enter relative min-h-[70vh] overflow-hidden">
      ...
      <div className="relative max-w-3xl mx-auto px-4 sm:px-6 py-8 sm:py-12">
        <div className="rounded-[1.75rem] bg-white/90 dark:bg-ink-900/85 border border-ink-200/60 dark:border-ink-800/50 shadow-xl backdrop-blur-xl p-6 sm:p-10 ring-gradient overflow-hidden">
          ...
          <h1 className="mt-2 text-3xl sm:text-4xl font-display font-extrabold tracking-tight text-ink-900 dark:text-white mb-2">
            Politique de{' '}
