...
export const TANGER_DESTINATIONS = {
  'chu-urgences': { lat: 35.7558, lng: -5.8285, name: 'Urgences CHU Tanger' },
  'chu-pediatrie': { lat: 35.7562, lng: -5.8278, name: 'Pédiatrie CHU' },
  'fmpt': { lat: 35.7545, lng: -5.8260, name: 'FMPT de Tanger' },
  'ispits': { lat: 35.7530, lng: -5.8250, name: 'ISPITS Tanger' },
  'residence-alliance': { lat: 35.7580, lng: -5.8310, name: 'Résidence Alliance' },
  'default': { lat: 35.7565, lng: -5.8280, name: 'Alliance & CHU Tanger' },
};
