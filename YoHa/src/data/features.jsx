...
export const FEATURES = [
  { icon:<I.Zap size={28}/>,    title:'Ultra rapide',           desc:'Au moins 45 min en moyenne à l\'Alliance et dans les hôpitaux.', from:'from-amber-400', to:'to-orange-500' },
  ...
  { icon:<I.MapPin size={28}/>, title:'Optimisé Alliance',        desc:'Livraison directe en chambre, à l\'aile hospitalière, à la BU.', from:'from-sky-400', to:'to-indigo-500' },
];
