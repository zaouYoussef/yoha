...
export const HOW_STEPS = [
  { num:'01', title:'Choisissez',  desc:'Parcourez les restaurants partenaires de votre résidence Alliance ou hôpital.', icon:<I.Search size={22}/>, color:'from-orange-500 to-amber-500' },
