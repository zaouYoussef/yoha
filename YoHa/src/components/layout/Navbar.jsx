        ...
        <div className="ml-auto flex min-w-0 items-center gap-1 sm:gap-2.5">
          {(!user || user.role === 'client') && isBrowsePage && (
            <button
              ...
              title="Mes commandes"
              className="cursor-grow hidden sm:flex items-center gap-1.5 sm:gap-2 px-3.5 py-2 rounded-xl bg-ink-100/90 dark:bg-ink-800/80 text-ink-900 dark:text-white border border-ink-200/60 dark:border-ink-700/60 hover:border-brand-500/50 hover:bg-brand-500/10 hover:text-brand-600 dark:hover:text-brand-400 transition-all duration-300 text-sm font-bold shadow-xs active:scale-95 shrink-0"
            >
