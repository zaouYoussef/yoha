  ...
  return (
    <div ref={dropdownRef} className="relative flex gap-2 items-stretch">
      ...
      <div className="flex-1 min-w-0">
        ...
        {open && (
          <div className="absolute z-50 top-full mt-2 left-0 right-0 w-full rounded-2xl border border-ink-200 dark:border-ink-700 bg-white dark:bg-ink-900 shadow-xl overflow-hidden animate-in fade-in slide-in-from-top-2 duration-200">
