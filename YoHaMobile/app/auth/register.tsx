...
import { brand, gradients, ink, radius } from '../../src/theme';
...
export default function RegisterScreen() {
  ...
  const handleRegister = async () => {
    ...
    try {
      ...
      setError(e instanceof Error ? e.message : 'Création de compte impossible');
    } finally {
      setLoading(false);
    }
  };
    ...
    <View style={[styles.container, { paddingTop: insets.top }]}>
      <ScrollView contentContainerStyle={styles.scrollContent} keyboardShouldPersistTaps="handled">
        ...
        <View style={styles.heroHeader}>
          ...
          <Text style={styles.heroTitle}>Créer un compte client</Text>
          <Text style={styles.heroSub}>Rejoignez la communauté YoHa et profitez de la livraison gratuite</Text>
        </View>
        ...
        <View style={styles.card}>
          ...
          <View style={styles.tabBar}>
            <Pressable
              onPress={() => { setTab('login'); router.push('/auth/login'); }}
          ...
          <View style={styles.dividerWrap}>
            ...
            <Text style={styles.dividerText}>ou avec vos informations</Text>
            <View style={styles.dividerLine} />
          </View>
          ...
          <Pressable onPress={handleRegister} disabled={loading} style={styles.submitBtnWrap}>
